<?php
    ...
    $query = "SELECT * FROM olimpo.usuario_mensal;"; 
...
<body>
    ...
    <main>
        ...
        <section class="section__btn">
            <a class="btn" href="login2.php">Novo</a>
        </section>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><?= $row['email'];?></td>
                            <td><?= $row['CPF'];?></td>
                            <td><?= $row['num_cartao'];?></td>
                            <td><?= $row['cvv'];?></td>
                            <td><?= $status;?></td>
                            <td class="td__operacao">
                                <a class="btnalterar" href="update.php?id=<?=$row['id'];?>">Alterar</a>
                                <a class="btnexcluir" href="delete.php?id=<?=$row['id'];?>" onclick="return confirm(' Confirma a operação?');">Excluir</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php endif; $dbh = null; ?>
